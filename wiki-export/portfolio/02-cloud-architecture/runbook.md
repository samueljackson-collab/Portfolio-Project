---
title: Runbook — PRJ-CLOUD-001 (AWS Landing Zone with Organizations & SSO)
description: Production operations runbook for AWS Landing Zone implementation with AWS Organizations and Single Sign-On (SSO). This runbook covers multi-account management, user access control, organizational pol
tags: [documentation, portfolio]
path: portfolio/02-cloud-architecture/runbook
created: 2026-03-08T22:19:12.958937+00:00
updated: 2026-03-08T22:04:38.233902+00:00
---
...
# Recreate policy using process substitution to avoid writing sensitive content to disk
aws organizations create-policy \
  --name $POLICY_NAME \
  --description "Restored from backup $(date)" \
  --type SERVICE_CONTROL_POLICY \
  --content file://<(jq -r '.Policy.Content' $BACKUP_FILE)
