...
description: - `poc_requests_total` (counter) - `poc_latency_p95_ms` (gauge) - `poc_worker_checks_success` / `poc_worker_checks_failure` (counters) - alert: PocLatencyHigh expr: poc_latency_p95_ms > 250 for: 5m la
tags: [documentation, portfolio]
path: portfolio/p09-cloud-native-poc/readme
created: 2026-03-08T22:19:14.012504+00:00
updated: 2026-03-08T22:04:38.114902+00:00
---
