...
description: For cross-project documentation, standards, and runbooks, see the [Portfolio Documentation Hub](../../../DOCUMENTATION_INDEX.md). **Status:** 🟠 In Progress Active Directory design and automation using
tags: [analytics, data-engineering, documentation, pipeline, portfolio]
path: portfolio/05-networking-datacenter/readme
created: 2026-03-08T22:19:12.992546+00:00
updated: 2026-03-08T22:04:38.270902+00:00
---
...
Active Directory design and automation using DSC and Ansible.
...
- [x] Active Directory automation roadmap aligned to the [Prompt Execution Framework workflow](../../../AI_PROMPT_EXECUTION_FRAMEWORK.md#prompt-execution-workflow).
