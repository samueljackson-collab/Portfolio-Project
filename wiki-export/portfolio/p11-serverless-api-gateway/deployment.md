---
title: Deployment Guide - P11 Serverless API Gateway
description: Before deploying, ensure you have: 1. **AWS Account** with appropriate permissions 2. **AWS CLI** installed and configured 3. **Python 3.11+** installed 4. **Git** (optional, for version control) The 
tags: [documentation, portfolio]
path: portfolio/p11-serverless-api-gateway/deployment
created: 2026-03-08T22:19:13.725013+00:00
