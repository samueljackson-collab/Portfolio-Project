...
description: Store pipeline run logs, security scan summaries, and SBOM outputs in date-stamped folders (for example, `deployments/2025-02-14/`). Recommended contents per deployment: - `pipeline-run.log` - `securi
tags: [documentation, portfolio]
path: portfolio/4-devsecops/readme
created: 2026-03-08T22:19:13.368438+00:00
updated: 2026-03-08T22:04:38.723902+00:00
---
