...
description: - `mr_healthcheck_latency_ms` (gauge) per region. - `mr_failover_events_total` (counter). - `mr_snapshot_replication_age_seconds` (gauge). - alert: FailoverActivated expr: increase(mr_failover_events_
tags: [documentation, portfolio]
path: portfolio/p10-multi-region/readme
created: 2026-03-08T22:19:14.031296+00:00
