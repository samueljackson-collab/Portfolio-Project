...
description: Use these as starting points, then validate with workload tests. - `shared_buffers`: 25-40% of RAM for dedicated DB hosts. - `work_mem`: 4-16MB per connection (adjust for concurrency). - `maintenance_
tags: [analytics, data-engineering, documentation, pipeline, portfolio]
path: portfolio/2-database-migration/config-recommendations
created: 2026-03-08T22:19:13.260870+00:00
