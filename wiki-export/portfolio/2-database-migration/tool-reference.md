...
description: Recommended setup for `postgres_exporter`: scrape_configs: - job_name: postgres static_configs: - targets: ['postgres-exporter:9187'] Example alerting rules: groups: - name: postgres rules: - alert: P
tags: [analytics, data-engineering, documentation, pipeline, portfolio]
path: portfolio/2-database-migration/tool-reference
created: 2026-03-08T22:19:13.258047+00:00
