---
title: Observability Evidence (Prometheus/Grafana)
description: - record: job:http_availability:ratio_rate5m expr: sum(rate(http_requests_total{status=~'2..'}[5m])) / sum(rate(http_requests_total[5m])) labels: service: reverse-proxy { 'title': 'Proxmox Cluster Hea
tags: [documentation, portfolio]
path: portfolio/06-homelab/observability-snapshots
created: 2026-03-08T22:19:13.044629+00:00
