...
description: This diagram is rendered using Mermaid syntax. GitHub will render it automatically when viewing this file. graph TB subgraph Management['🖥️ Management Layer'] WebUI[Proxmox Web UI<br/>192.168.40.10:80
tags: [documentation, portfolio]
path: portfolio/06-homelab/virtualization-architecture
created: 2026-03-08T22:19:13.027697+00:00
updated: 2026-03-08T22:04:38.342902+00:00
---
...
graph TB
    ...
    subgraph ProxmoxCluster["⚙️ Proxmox VE Cluster (HA Enabled)"]
    ...
    subgraph CoreServices["🛠️ Core Infrastructure Services (VMs on VLAN 40)"]
    ...
    subgraph Applications["📦 Application VMs"]
    ...
    %% Legend
    Legend["📋 Architecture Legend:<br/>🟢 Cluster Nodes - HA Enabled<br/>🟣 Storage - Multi-Tier Strategy<br/>🟡 Core Services - Infrastructure<br/>🟠 Applications - User-Facing<br/>🔵 Management - Control Plane<br/>🟦 Automation - IaC & Scripts<br/>🟨 Network - Connectivity<br/>━━ Active Connection<br/>┄┄ Management/Monitoring"]

    style Legend fill:#F0F8FF,stroke:#4169E1,stroke-width:2px,text-align:left

    %% Technical Specifications
    Specs["⚙️ Technical Specifications:<br/><br/>Cluster:<br/>• 3 nodes, quorum-based HA<br/>• Corosync + Pacemaker<br/>• Automatic VM failover<br/>• Watchdog-based fencing<br/><br/>Storage:<br/>• Tier 1: Local LVM (performance)<br/>• Tier 2: Ceph RBD (HA, 3x replication)<br/>• Tier 3: NFS/iSCSI (capacity)<br/>• Backup: PBS (dedup + compression)<br/><br/>Recovery:<br/>• RTO: 1 hour (P0), 4 hours (P1)<br/>• RPO: 24 hours<br/>• Quarterly DR testing<br/>• 3-2-1 backup strategy"]
...
Original: `virtualization-architecture.mermaid`
