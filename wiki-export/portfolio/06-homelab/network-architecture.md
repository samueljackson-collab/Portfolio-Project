...
description: This diagram is rendered using Mermaid syntax. GitHub will render it automatically when viewing this file. graph TB subgraph Internet['🌐 Internet'] ISP[ISP Connection] end subgraph Security['🔒 Securit
tags: [documentation, portfolio]
path: portfolio/06-homelab/network-architecture
created: 2026-03-08T22:19:13.103090+00:00
