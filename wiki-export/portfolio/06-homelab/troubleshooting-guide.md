...
description: - **Check cluster quorum:** `pvecm status` - **Corosync logs:** `/var/log/syslog` or `journalctl -u corosync` - **Restart services:** `systemctl restart pve-cluster pvedaemon pveproxy` - **NFS:** `sho
tags: [documentation, portfolio]
path: portfolio/06-homelab/troubleshooting-guide
created: 2026-03-08T22:19:13.062501+00:00
