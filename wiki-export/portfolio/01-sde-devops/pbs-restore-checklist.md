---
title: PBS Restore Checklist (Sanitized Example)
description: 1. **Select snapshot** from `demo-datastore` for the affected VM/container. 2. **Restore target** - Option A: Restore in-place with `start-after-restore: true`. - Option B: Restore to staging VM ID wi
tags: [documentation, portfolio]
path: portfolio/01-sde-devops/pbs-restore-checklist
created: 2026-03-08T22:19:12.894476+00:00
