---
title: AI Prompts for 3D Architecture Diagrams
description: These prompts can be used with tools like: - **Midjourney** (Discord bot) - **DALL-E 3** (ChatGPT Plus / API) - **Stable Diffusion** (Local/Cloud) - **Adobe Firefly** - **Canva AI** Create a detailed 
tags: [documentation, portfolio]
path: portfolio/01-sde-devops/01-architecture-3d-diagram
created: 2026-03-08T22:19:12.943750+00:00
