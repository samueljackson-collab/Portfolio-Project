...
description: - Terraform >= 1.5 - AWS CLI v2 configured with credentials for each environment - Optional: Infracost, tfsec, Terratest tooling 1. `cd terraform/environments/<env>` 2. Create/verify backend S3 bucket
tags: [documentation, portfolio]
path: portfolio/01-sde-devops/deployment-guide
created: 2026-03-08T22:19:12.912638+00:00
