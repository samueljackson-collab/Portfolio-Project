---
title: AWS Setup Guide (us-west-2, SamSJPortfolio)
description: This guide walks through **setting up AWS from scratch** in **us-west-2**, using the naming suffix **SamSJPortfolio**. The steps are written for someone new to AWS. - An AWS account with billing, MFA,
tags: [documentation, portfolio]
path: portfolio/docs/aws-setup-samsjportfolio
created: 2026-03-08T22:19:14.074699+00:00
