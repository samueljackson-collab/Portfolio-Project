...
description: This guide describes the minimal steps to get started with this repository locally and to configure CI/Deploy. Prerequisites - Git - Terraform 1.6.x (or compatible) - AWS CLI configured (if you will d
tags: [documentation, portfolio]
path: portfolio/docs/github-repository-setup-guide
created: 2026-03-08T22:19:14.070590+00:00
