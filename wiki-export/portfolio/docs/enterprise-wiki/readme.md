---
title: Enterprise Portfolio Wiki Reference
description: This page is the external reference for the interactive `EnterpriseWiki` component. Each section includes anchors so that the 'View Detailed Guide' and related calls to action in the UI land directly 
tags: [documentation, portfolio]
path: portfolio/docs/enterprise-wiki/readme
created: 2026-03-08T22:19:14.081639+00:00
