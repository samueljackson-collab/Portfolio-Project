---
title: AWS Cost Optimization & FinOps Guide
description: 1. [Cost Analysis Framework](#cost-analysis) 2. [Compute Optimization](#compute-optimization) 3. [Storage Optimization](#storage-optimization) 4. [Network Optimization](#network-optimization) 5. [Data
tags: [documentation, portfolio]
path: portfolio/docs/cost-optimization/aws-cost-optimization-guide
created: 2026-03-08T22:19:14.088372+00:00
...
// Cost: 1TB × $0.085/GB + 400GB origin = $93/month
// Savings: $87/month
```
...
```hcl
# Terraform tag policy enforcement
...
- [Production Runbooks](../runbooks/README.md)
...
- [Infracost - Cost estimates for Terraform](https://www.infracost.io/)
