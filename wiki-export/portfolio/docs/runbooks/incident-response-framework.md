...
description: This document defines the incident response process, roles, responsibilities, and communication procedures for production incidents. 1. DETECT → 2. TRIAGE → 3. MITIGATE → 4. RESOLVE → 5. POSTMORTEM **
tags: [documentation, portfolio]
path: portfolio/docs/runbooks/incident-response-framework
created: 2026-03-08T22:19:14.086305+00:00
