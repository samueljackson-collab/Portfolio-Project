...
description: - **Portfolio Orchestration Overview** (Grafana): request rates, latency, orchestration run counters, collector logs. - **Collector health**: verify `otel-collector` scrape status via Prometheus expor
tags: [documentation, portfolio]
path: portfolio/docs/runbooks/observability-runbook
created: 2026-03-08T22:19:14.085930+00:00
