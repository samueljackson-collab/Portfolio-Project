---
title: Playbook — P01 (AWS Infrastructure Automation)
description: NEW_PASSWORD=$(openssl rand -base64 32) aws secretsmanager update-secret \ --secret-id /myapp/prod/db-password \ --secret-string '$NEW_PASSWORD' aws rds modify-db-instance \ --db-instance-identifier m
tags: [aws, cloud, documentation, infrastructure, portfolio]
path: portfolio/p01-aws-infra/playbook
created: 2026-03-08T22:19:13.471587+00:00
