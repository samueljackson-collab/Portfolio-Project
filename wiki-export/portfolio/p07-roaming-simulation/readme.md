...
description: - `roaming_attach_success` (counter) – attach successes per PLMN. - `roaming_latency_p95_ms` (gauge) – rolling p95 attach latency. - `roaming_drop_call_pct` (gauge) – percentage of dropped sessions. -
tags: [documentation, portfolio]
path: portfolio/p07-roaming-simulation/readme
created: 2026-03-08T22:19:13.967932+00:00
