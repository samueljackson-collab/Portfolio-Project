...
description: This directory stores deployment evidence for the AWS Infrastructure Automation project. - `console-vpc.png` - `console-subnets.png` - `console-rds.png` - `cost-explorer-chart.png` - `outputs.json` > 
tags: [aws, cloud, documentation, infrastructure, portfolio]
path: portfolio/1-aws-infrastructure-automation/readme
created: 2026-03-08T22:19:13.166886+00:00
updated: 2026-03-08T22:04:38.469902+00:00
---

# Evidence Artifacts

This directory stores deployment evidence for the AWS Infrastructure Automation project.

## Console screenshots (pending)
- `console-vpc.png`
- `console-subnets.png`
- `console-rds.png`

## Cost estimate (pending)
- `cost-explorer-chart.png`

## Terraform outputs
- `outputs.json`

> Note: Screenshots and cost charts require access to the dedicated dev AWS account and AWS Console.
