---
title: P08 Metrics & Dashboards
description: **Purpose:** Monitor Lambda function performance, errors, and cost efficiency. **Metrics:** - **Invocation Count** (AWS/Lambda `Invocations`): Count of Lambda executions per function (5-min granularit
tags: [documentation, portfolio]
path: portfolio/p08/metrics
created: 2026-03-08T22:19:13.973597+00:00
