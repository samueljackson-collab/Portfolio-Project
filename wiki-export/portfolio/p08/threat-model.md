...
description: - **Data:** Raw files (S3 raw bucket), processed files (S3 processed bucket), ETL metadata (DynamoDB), DLQ messages - **Compute:** Lambda function code, Step Functions state machine definitions, execu
tags: [documentation, portfolio]
path: portfolio/p08/threat-model
created: 2026-03-08T22:19:13.970324+00:00
