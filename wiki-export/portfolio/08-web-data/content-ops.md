---
title: Content & Catalog Operations Runbook (Sanitized)
description: 1. **Extract** supplier CSV/Excel to staging and normalize headers to canonical schema (`sku`, `name`, `price`, `stock_qty`, `category_path`, `attributes_json`). 2. **Validate** using [catalog import 
tags: [analytics, data-engineering, documentation, pipeline, portfolio]
path: portfolio/08-web-data/content-ops
created: 2026-03-08T22:19:13.143317+00:00
