---
title: Master Artifacts
description: - **Terraform environments**: `infrastructure/terraform/environments/main.tf` with dev/staging/prod variables (`dev.tfvars`, `staging.tfvars`, `prod.tfvars`) and shared inputs in `variables.tf`. - **A
tags: [documentation, portfolio]
path: portfolio/general/master-artifacts
created: 2026-03-08T22:19:14.056016+00:00
