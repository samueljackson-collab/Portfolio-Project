...
description: Store stack startup logs, health snapshots, and release notes in date-stamped folders (for example, `deployments/2025-02-14/`). Recommended contents per deployment: - `docker-compose.log` - `stack-hea
tags: [documentation, grafana, monitoring, observability, portfolio]
path: portfolio/23-advanced-monitoring/readme
created: 2026-03-08T22:19:13.304042+00:00
updated: 2026-03-08T22:04:38.652902+00:00
---
