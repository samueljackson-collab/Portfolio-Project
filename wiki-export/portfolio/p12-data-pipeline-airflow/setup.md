---
title: P12 Data Pipeline (Airflow) - Setup Guide
description: This project contains a complete Airflow ETL data pipeline with Docker Compose setup for local development and testing. The pipeline includes: - **Extract DAG**: Extracts data from source databases - 
tags: [analytics, data-engineering, documentation, pipeline, portfolio]
path: portfolio/p12-data-pipeline-airflow/setup
created: 2026-03-08T22:19:13.742242+00:00
