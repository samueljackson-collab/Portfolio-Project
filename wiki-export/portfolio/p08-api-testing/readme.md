...
description: - `api_contract_drift_total` (counter) – number of schema mismatches. - `api_test_pass_ratio` (gauge) – pass percentage per run. - `api_latency_p95_ms` (gauge) – p95 response time during tests. - aler
tags: [documentation, portfolio]
path: portfolio/p08-api-testing/readme
created: 2026-03-08T22:19:13.994249+00:00
