# Web Application Testing Framework - Operations Runbook

**Version:** 1.0.0 | **Last Updated:** 2025-11-10

## Overview

This runbook provides operational procedures, troubleshooting guides, and incident response workflows for Web Application Testing Framework.
...
- **Service Name:** Web Application Testing Framework
...
- **Grafana:** https://grafana.example.com/d/web-testing
- **CloudWatch:** https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=web-testing
...
**Alert:** `web-testing_high_error_rate`
...
```bash
# Check error logs
aws logs tail /aws/lambda/web-testing --follow --filter '5xx'

# Check service health
kubectl get pods -n web-testing
kubectl logs -n web-testing <pod-name> --tail=100
```
...
**Alert:** `web-testing_high_latency`
...
aws rds describe-db-instances --db-instance-identifier web-testing-prod
...
kubectl top pods -n web-testing
...
```markdown
# Incident Report: web-testing Outage
...
aws s3 ls s3://backups-web-testing/latest/
```
...
cat /etc/logrotate.d/web-testing

# Test log rotation
logrotate -d /etc/logrotate.d/web-testing
```
