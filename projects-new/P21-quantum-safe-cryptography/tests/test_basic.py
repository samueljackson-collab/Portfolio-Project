"""
Test suite for P21-quantum-safe-cryptography
Post-quantum cryptography implementation with hybrid TLS
"""
...
def test_docker_producer_exists():
    ...
    assert (producer_dir / "main.py").exists(), "Missing producer main.py"
...
def test_artifacts_directory():
    """Test that artifacts directory exists or can be created."""
