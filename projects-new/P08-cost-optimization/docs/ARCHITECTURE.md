# Cost Optimization Tooling - Architecture Documentation
...
Cost Optimization Tooling is built following cloud-native architecture principles with a focus on scalability, reliability, and security.
