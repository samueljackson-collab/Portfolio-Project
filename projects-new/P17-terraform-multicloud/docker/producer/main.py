"""Sample producer for Modular Terraform targeting AWS/Azure with shared variables and CI validation.."""
...
def build_payload(custom=None):
    payload = {
        "project": "P17",
        "slug": "terraform-multicloud",
        "summary": "Modular Terraform targeting AWS/Azure with shared variables and CI validation.",
