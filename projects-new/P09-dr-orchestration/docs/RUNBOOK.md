# Disaster Recovery Orchestration - Operations Runbook

**Version:** 1.0.0 | **Last Updated:** 2025-11-10

## Overview

This runbook provides operational procedures, troubleshooting guides, and incident response workflows for Disaster Recovery Orchestration.
...
- **Service Name:** Disaster Recovery Orchestration
...
- **Grafana:** https://grafana.example.com/d/dr-orchestration
- **CloudWatch:** https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=dr-orchestration
...
**Alert:** `dr-orchestration_high_error_rate`
...
```bash
# Check error logs
aws logs tail /aws/lambda/dr-orchestration --follow --filter '5xx'

# Check service health
kubectl get pods -n dr-orchestration
kubectl logs -n dr-orchestration <pod-name> --tail=100
```
...
**Alert:** `dr-orchestration_high_latency`
...
aws rds describe-db-instances --db-instance-identifier dr-orchestration-prod
...
kubectl top pods -n dr-orchestration
...
```markdown
# Incident Report: dr-orchestration Outage
...
aws s3 ls s3://backups-dr-orchestration/latest/
```
...
cat /etc/logrotate.d/dr-orchestration

# Test log rotation
logrotate -d /etc/logrotate.d/dr-orchestration
```
