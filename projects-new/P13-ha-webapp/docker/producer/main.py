"""Sample producer for NGINX front-end with replicated app tier and resilient session handling.."""
...
def build_payload(custom=None):
    payload = {
        "project": "P13",
        "slug": "ha-webapp",
        "summary": "NGINX front-end with replicated app tier and resilient session handling.",
