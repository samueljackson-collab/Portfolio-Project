# AWS Infrastructure Automation - Architecture Documentation
...
AWS Infrastructure Automation is built following cloud-native architecture principles with a focus on scalability, reliability, and security.
