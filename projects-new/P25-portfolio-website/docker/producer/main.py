"""Sample producer for Static+API hybrid site with content build pipeline and uptime probes.."""
...
def build_payload(custom=None):
    payload = {
        ...
        "summary": "Static+API hybrid site with content build pipeline and uptime probes.",
