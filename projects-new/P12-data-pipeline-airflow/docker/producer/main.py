"""Sample producer for Containerized Airflow ETL with sample DAGs and data quality checks.."""
...
def build_payload(custom=None):
    payload = {
        ...
        "summary": "Containerized Airflow ETL with sample DAGs and data quality checks.",
