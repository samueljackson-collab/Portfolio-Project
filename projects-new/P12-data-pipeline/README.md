...
| Run DAG simulation | `python app.py` | ETL pipeline (extract → transform → load) executes; log written to `artifacts/airflow_dag_run.log`. |
| Validate quality | `pytest tests/ -v` | All pipeline step and artifact tests pass. |
