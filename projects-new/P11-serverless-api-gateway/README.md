...
Build a Lambda + API Gateway stack with DynamoDB persistence and observability hooks.
...
## Quick start
```bash
cd /workspace/Portfolio-Project/projects-new/P11-serverless-api-gateway
