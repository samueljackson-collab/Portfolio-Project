"""Sample producer for Build a Lambda + API Gateway stack with DynamoDB persistence and observability hooks.."""
...
def build_payload(custom=None):
    payload = {
        ...
        "summary": "Build a Lambda + API Gateway stack with DynamoDB persistence and observability hooks.",
