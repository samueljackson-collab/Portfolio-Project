# Security Compliance Automation - Operations Runbook

**Version:** 1.0.0 | **Last Updated:** 2025-11-10

## Overview

This runbook provides operational procedures, troubleshooting guides, and incident response workflows for Security Compliance Automation.
...
- **Service Name:** Security Compliance Automation
...
- **Grafana:** https://grafana.example.com/d/security-compliance
- **CloudWatch:** https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=security-compliance
...
**Alert:** `security-compliance_high_error_rate`
...
```bash
# Check error logs
aws logs tail /aws/lambda/security-compliance --follow --filter '5xx'

# Check service health
kubectl get pods -n security-compliance
kubectl logs -n security-compliance <pod-name> --tail=100
```
...
**Alert:** `security-compliance_high_latency`
...
aws rds describe-db-instances --db-instance-identifier security-compliance-prod
...
kubectl top pods -n security-compliance
...
```markdown
# Incident Report: security-compliance Outage
...
aws s3 ls s3://backups-security-compliance/latest/
```
...
cat /etc/logrotate.d/security-compliance

# Test log rotation
logrotate -d /etc/logrotate.d/security-compliance
```
