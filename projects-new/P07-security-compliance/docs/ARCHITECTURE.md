# Security Compliance Automation - Architecture Documentation
...
Security Compliance Automation is built following cloud-native architecture principles with a focus on scalability, reliability, and security.
