"""
Test suite for P24-report-generator
...
def test_report_templates_exist():
    """Test that report templates directory exists."""
    templates_dir = PROJECT_ROOT / "REPORT_TEMPLATES"
    assert templates_dir.exists(), "Missing REPORT_TEMPLATES directory"
