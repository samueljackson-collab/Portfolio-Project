"""Sample producer for Composable reporting jobs with templated outputs and schedulable runs.."""
...
def build_payload(custom=None):
    payload = {
        ...
        "summary": "Composable reporting jobs with templated outputs and schedulable runs.",
