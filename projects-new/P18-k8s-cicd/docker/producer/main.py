"""Sample producer for GitOps-style deployment pipeline with container builds and manifest promotion.."""
...
def build_payload(custom=None):
    payload = {
        "project": "P18",
        "slug": "k8s-cicd",
        "summary": "GitOps-style deployment pipeline with container builds and manifest promotion.",
