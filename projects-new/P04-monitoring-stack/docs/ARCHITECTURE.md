# Operational Monitoring Stack - Architecture Documentation
...
Operational Monitoring Stack is built following cloud-native architecture principles with a focus on scalability, reliability, and security.
