# Performance Load Testing - Operations Runbook

**Version:** 1.0.0 | **Last Updated:** 2025-11-10

## Overview

This runbook provides operational procedures, troubleshooting guides, and incident response workflows for Performance Load Testing.
...
- **Service Name:** Performance Load Testing
...
- **Grafana:** https://grafana.example.com/d/load-testing
- **CloudWatch:** https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=load-testing
...
**Alert:** `load-testing_high_error_rate`
...
```bash
# Check error logs
aws logs tail /aws/lambda/load-testing --follow --filter '5xx'

# Check service health
kubectl get pods -n load-testing
kubectl logs -n load-testing <pod-name> --tail=100
```
...
**Alert:** `load-testing_high_latency`
...
aws rds describe-db-instances --db-instance-identifier load-testing-prod
...
```markdown
# Incident Report: load-testing Outage
...
aws s3 ls s3://backups-load-testing/latest/
```
...
cat /etc/logrotate.d/load-testing

# Test log rotation
logrotate -d /etc/logrotate.d/load-testing
```
