# Network Configuration Automation - Operations Runbook

**Version:** 1.0.0 | **Last Updated:** 2025-11-10

## Overview

This runbook provides operational procedures, troubleshooting guides, and incident response workflows for Network Configuration Automation.
...
- **Service Name:** Network Configuration Automation
...
- **Grafana:** https://grafana.example.com/d/network-automation
- **CloudWatch:** https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#dashboards:name=network-automation
...
**Alert:** `network-automation_high_error_rate`
...
```bash
# Check error logs
aws logs tail /aws/lambda/network-automation --follow --filter '5xx'

# Check service health
kubectl get pods -n network-automation
kubectl logs -n network-automation <pod-name> --tail=100
```
...
**Alert:** `network-automation_high_latency`
...
aws rds describe-db-instances --db-instance-identifier network-automation-prod
...
kubectl top pods -n network-automation
...
```markdown
# Incident Report: network-automation Outage
...
aws s3 ls s3://backups-network-automation/latest/
```
...
cat /etc/logrotate.d/network-automation

# Test log rotation
logrotate -d /etc/logrotate.d/network-automation
```
