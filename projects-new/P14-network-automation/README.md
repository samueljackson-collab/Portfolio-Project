...
Network Configuration Automation implements enterprise-grade solutions following the standards defined in the [Enterprise Engineer's Handbook](../../docs/PRJ-MASTER-HANDBOOK/README.md).
