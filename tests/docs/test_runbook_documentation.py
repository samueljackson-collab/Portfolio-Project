    ...
    def test_bash_commands_are_valid(self, runbook_files):
        ...
        for runbook in runbook_files:
            ...
            for block in bash_blocks:
                ...
                has_valid_command = any(cmd in block for cmd in valid_commands)
                ...
                assert (
                    has_valid_command or has_shell_construct
    ...
    def test_sql_commands_are_valid(self, runbook_files):
        ...
        for runbook in runbook_files:
            ...
            for block in sql_blocks:
                ...
                assert has_sql, f"{runbook.name} has SQL block without SQL keywords"
...
class TestRunbookREADME:
    ...
    def test_readme_lists_all_runbooks(self, readme, runbook_files):
        ...
        for runbook in runbook_files:
            ...
            assert (
                runbook.name in content or name_part in content
...
class TestIncidentResponseFramework:
    ...
    def test_framework_has_severity_matrix(self, framework):
        ...
        has_priorities = any(
            p in content for p in ["P0", "P1", "P2", "P3", "Sev 1", "Sev 2"]
        )
    ...
    def test_framework_has_communication_procedures(self, framework):
        ...
        has_communication = any(
            keyword in content for keyword in communication_keywords
        )
...
class TestRunbookContentQuality:
    ...
    def test_runbook_has_actionable_steps(self, runbook_files):
        ...
        for runbook in runbook_files:
            ...
            has_steps = bool(re.search(r"^\d+\.\s", content, re.MULTILINE)) or bool(
    ...
    def test_runbook_has_time_estimates(self, runbook_files):
        ...
        for runbook in runbook_files:
            ...
            has_time_estimate = any(
                re.search(pattern, content) for pattern in time_patterns
            )
            assert (
                has_time_estimate
...
class TestRunbookSpecificContent:
    ...
    def test_database_runbook_content(self):
        ...
        runbook = (
            BASE_PATH / "docs/runbooks/runbook-database-connection-pool-exhaustion.md"
        )
