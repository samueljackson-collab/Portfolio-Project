    ...
    def test_typescript_code_syntax(self, adr_files):
        ...
        for adr_file in adr_files:
            ...
            for block in ts_blocks:
                ...
                has_keywords = any(
                    keyword in block 
                    for keyword in ["const", "let", "var", "function", "class", "interface", "type", "async", "await", "return"]
                )
                assert has_keywords, \
    ...
    def test_bash_code_syntax(self, adr_files):
        ...
        for adr_file in adr_files:
            ...
            for block in bash_blocks:
                ...
                has_commands = any(
                    keyword in block 
                    for keyword in ["kubectl", "aws", "curl", "echo", "export", "if", "for", "while", "$"]
                )
                assert has_commands, \
...
class TestADRREADME:
    ...
    def test_readme_lists_all_adrs(self, readme, adr_files):
        ...
        for adr_file in adr_files:
            ...
            assert adr_name in content or adr_file.name in content, \
    ...
    def test_readme_links_are_valid(self, readme):
        ...
        for text, link in matches:
            ...
            assert link_path.exists(), \
                f"README has broken link: [{text}]({link})"
    ...
    def test_readme_has_table(self, readme):
        ...
        assert "|-" in content or "|--" in content, "README should contain table header separator"
...
class TestADRContentQuality:
    ...
    def test_adr_has_consequences_or_tradeoffs(self, adr_files):
        ...
        keywords = ["consequence", "trade-off", "tradeoff", "benefit", "drawback", "advantage", "disadvantage", "positive", "negative"]
...
class TestADRSpecificContent:
    ...
    def test_adr_005_observability_content(self):
        ...
        adr_file = BASE_PATH / "docs/adr/ADR-005-comprehensive-observability-strategy.md"
        if not adr_file.exists():
        ...
        required_topics = ["metric", "log", "trace", "monitoring", "prometheus", "grafana"]
        for topic in required_topics:
    ...
    def test_adr_006_security_content(self):
        ...
        required_topics = ["security", "authentication", "authorization", "encryption", "zero-trust"]
        for topic in required_topics:
