...
class TestPRJHOME001Configs:
    ...
    def test_pfsense_config_valid_xml(self):
        ...
        config_path = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-001/assets/pfsense/pfsense-config.xml"
        )
    ...
    def test_unifi_config_valid_json(self):
        ...
        config_path = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-001/assets/unifi/unifi-config.json"
        )
    ...
    def test_network_architecture_mermaid_exists(self):
        ...
        diagram_path = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-001/assets/documentation/network-architecture.mermaid"
        )
    ...
    def test_network_inventory_exists(self):
        ...
        inventory_path = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-001/assets/documentation/network-inventory.md"
        )
    ...
    def test_security_policies_exists(self):
        ...
        policies_path = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-001/assets/documentation/security-policies.md"
        )
...
class TestPRJHOME002Configs:
    ...
    def test_proxmox_cluster_conf_exists(self):
        ...
        config_path = (
            BASE_PATH / "projects/06-homelab/PRJ-HOME-002/assets/proxmox/cluster.conf"
        )
    ...
    def test_proxmox_storage_cfg_exists(self):
        ...
        config_path = (
            BASE_PATH / "projects/06-homelab/PRJ-HOME-002/assets/proxmox/storage.cfg"
        )
        assert config_path.exists()
    ...
    def test_proxmox_network_interfaces_exists(self):
        ...
        config_path = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-002/assets/proxmox/network-interfaces"
        )
        assert config_path.exists()
    ...
    def test_backup_config_valid_json(self):
        ...
        config_path = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-002/assets/proxmox/backup-config.json"
        )
        assert config_path.exists()
    ...
    def test_cloud_init_config_valid_yaml(self):
        ...
        config_path = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-002/assets/proxmox/vm-templates/cloud-init-config.yml"
        )
        assert config_path.exists()
    ...
    def test_ansible_inventory_valid_yaml(self):
        ...
        config_path = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-002/assets/automation/ansible/inventory/hosts.yml"
        )
        assert config_path.exists()
    ...
    def test_ansible_playbooks_valid_yaml(self):
        ...
        playbooks_dir = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-002/assets/automation/ansible/playbooks"
        )
    ...
    def test_terraform_files_exist(self):
        ...
        terraform_dir = (
            BASE_PATH / "projects/06-homelab/PRJ-HOME-002/assets/automation/terraform"
        )
    ...
    def test_operational_scripts_exist(self):
        ...
        scripts_dir = (
            BASE_PATH / "projects/06-homelab/PRJ-HOME-002/assets/automation/scripts"
        )
    ...
    def test_dr_plan_exists(self):
        ...
        dr_plan_path = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-002/assets/recovery/disaster-recovery-plan.md"
        )
    ...
    def test_recovery_procedures_exist(self):
        ...
        recovery_dir = (
            BASE_PATH
            / "projects/06-homelab/PRJ-HOME-002/assets/recovery/recovery-procedures"
        )
