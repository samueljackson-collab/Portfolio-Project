...
def get_code_gen_prompts_section(project_name: str, project_type: str) -> str:
    ...
    prompt_config = prompts_by_type.get(
        project_type,
        {
...
def add_prompts_to_readme(
    readme_path: Path, project_name: str, project_type: str
) -> bool:
    ...
    if (
        "## Code Generation Prompts" in content
        or "# Code Generation Prompts" in content
    ):
