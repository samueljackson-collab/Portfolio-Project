...
type RoleKey = 'sde' | 'devops' | 'qa' | 'architect';
...
const EnterpriseWiki: React.FC = () => {
  ...
  const progress = Math.round((activeWeek.number / currentRole.weeks) * 100);
              ...
              <div className="mt-6 pt-6 border-t border-slate-700">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-xs text-slate-400">
                    <span>
                      Week {activeWeek.number} of {currentRole.weeks}
                    </span>
                    <span>{progress}%</span>
                  </div>
                  <div className="w-full bg-slate-700 rounded-full h-2">
                    <div
                      ...
                      style={{ width: `${(activeWeek.number / currentRole.weeks) * 100}%` }}
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="bg-slate-800 rounded-xl p-6 shadow-xl">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-white">
                    Week {activeWeek.number}: {activeWeek.title}
                  </h3>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <ul className="space-y-2">
                    {activeWeek.topics.map((topic, idx) => (
                      <li key={topic} className="flex items-start gap-2">
                        <div
                          className={`w-6 h-6 rounded-full bg-${currentRole.color}-600 flex items-center justify-center flex-shrink-0 mt-0.5`}
                        >
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {activeWeek.deliverables.map((deliverable) => (
              ...
              <div className="mt-6 pt-6 border-t border-slate-700 flex gap-4">
                <button
                  className={`flex-1 py-3 px-6 bg-${currentRole.color}-600 text-white rounded-lg font-semibold hover:bg-${currentRole.color}-700 transition-colors`}
                >
                  View Detailed Guide
                </button>
