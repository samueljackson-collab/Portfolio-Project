# ECS Application Module - Fargate-based containerized application
# Provisions ECS cluster, task definition, service, and load balancer
...
resource "aws_iam_role_policy" "app_database" {
  count = var.database_security_group_id != "" ? 1 : 0
  name  = "${local.name_prefix}-app-db-access"
...
resource "aws_ecs_service" "app" {
  ...
  deployment_configuration {
    ...
    minimum_healthy_percent = var.min_percent
  }
