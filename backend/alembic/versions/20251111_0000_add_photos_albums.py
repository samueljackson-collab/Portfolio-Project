...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_albums_owner_type", "albums", ["owner_id", "type"], unique=False
    )
    op.create_index(
        "ix_albums_owner_updated", "albums", ["owner_id", "updated_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "state", sa.String(length=255), nullable=True, comment="State/region name"
        ),
        sa.Column(
            "country", sa.String(length=255), nullable=True, comment="Country name"
        ),
        sa.Column(
            "camera_make",
        ...
        sa.Column(
            "camera_model", sa.String(length=100), nullable=True, comment="Camera model"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_index(
        op.f("ix_photos_capture_date"), "photos", ["capture_date"], unique=False
    )
    ...
    op.create_index(
        "ix_photos_owner_capture", "photos", ["owner_id", "capture_date"], unique=False
    )
    op.create_index(
        "ix_photos_owner_city", "photos", ["owner_id", "city"], unique=False
    )
    op.create_index(
        "ix_photos_album_capture", "photos", ["album_id", "capture_date"], unique=False
    )
    op.create_index(
        "ix_photos_location", "photos", ["latitude", "longitude"], unique=False
    )
