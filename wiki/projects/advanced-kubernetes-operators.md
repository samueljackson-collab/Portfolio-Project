...
|---------|-------------|-------------|
| [MLOps Platform](/projects/mlops-platform) | End-to-end MLOps workflow for training, evaluating... | 2 |
...
| 📖 Documentation | [`projects/19-advanced-kubernetes-operators/docs/`](projects/19-advanced-kubernetes-operators/docs/) |
