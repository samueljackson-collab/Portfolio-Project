...
### Step 1: Implementing Low-latency inference

**Objective:** Build low-latency inference with production-grade quality.
...
### Step 2: Implementing Model optimization

**Objective:** Build model optimization with production-grade quality.
...
### Step 3: Implementing Containerized deployment

**Objective:** Build containerized deployment with production-grade quality.
...
|---------|-------------|-------------|
| [IoT Data Analytics](/projects/iot-data-analytics) | Edge-to-cloud ingestion stack with MQTT telemetry ... | 1 |
...
| 📖 Documentation | [`projects/14-edge-ai-inference/docs/`](projects/14-edge-ai-inference/docs/) |
