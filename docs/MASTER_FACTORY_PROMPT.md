...
- Ensure every listed section is fully delivered—no omissions or placeholders.
- The generated content must include the actual narratives, diagrams, registers, and governance details instead of asking someone else to create them later.
- Avoid telling the AI to produce additional code or data outside the deliverable pack; respond with the final artifacts directly.
