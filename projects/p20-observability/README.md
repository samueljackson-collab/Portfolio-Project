...
| Dependency / blocker | Dependency on shared platform backlog for p20-observability |
...
| --- | --- | --- | --- | --- |
| Milestone 1: implementation checkpoint | 2026-12-09 | Data Engineering | 🟠 In Progress | Advance core deliverables for p20-observability. |
