"""
Test suite for 11-iot-data-analytics
"""
...
def test_mqtt_config_exists():
    """Test that MQTT broker configuration exists."""
    mosquitto_dir = PROJECT_ROOT / "mosquitto"
    assert mosquitto_dir.exists(), "Missing mosquitto directory"
...
def test_init_scripts_exist():
    """Test that initialization scripts exist."""
    init_dir = PROJECT_ROOT / "init-scripts"
    assert init_dir.exists(), "Missing init-scripts directory"
