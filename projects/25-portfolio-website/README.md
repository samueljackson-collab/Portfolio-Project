...
| Detail | Value |
| --- | --- |
| Live URL | `https://25-portfolio-website.staging.portfolio.example.com` |
| DNS | `25-portfolio-website.staging.portfolio.example.com` → `CNAME portfolio-gateway.staging.example.net` |
