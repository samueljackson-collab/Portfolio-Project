# EKS Multi-Region Module
# Creates EKS clusters across multiple regions with cross-region connectivity
...
resource "aws_security_group" "eks_nodes" {
  ...
  # Cross-region communication (for DR)
  dynamic "ingress" {
    for_each = var.cross_region_cidr_blocks
    content {
      description = "Allow traffic from ${ingress.value.region}"
      from_port   = 0
      to_port     = 0
      protocol    = "-1"
