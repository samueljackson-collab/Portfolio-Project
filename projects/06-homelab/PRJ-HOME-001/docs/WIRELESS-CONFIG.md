...
|------|---------------|----------|----------------|----------|-----------------------------|
| **Homelab-Secure** | VLAN 10 / `192.168.1.0/24` | WPA3-Enterprise (SAE transition **off**), RADIUS `192.168.40.25:1812`, shared secret `Radius!Homelab2025` | 2.4 GHz **on** (20 MHz), 5 GHz **on** (80 MHz), band steering **Prefer 5 GHz** | 802.11r Fast Roaming **Adaptive**, 802.11k/v **on**, PMF **Required**, Minimum RSSI `-67 dBm`, DTIM `3`, Multicast Enhancement **on** | Peak clients: **18**, Avg RSSI: **-62 dBm**, 95th percentile throughput: **420 Mbps down / 320 Mbps up**, Roam success: **99.7%** |
| **Homelab-IoT** | VLAN 20 / `192.168.20.0/24` | WPA2-PSK (AES), passphrase `I0t-Edge-Access!2025`, PMF **Optional** | 2.4 GHz **on** (20 MHz), 5 GHz **off** | Client Isolation **on**, Minimum RSSI `-75 dBm`, DTIM `2`, Schedule **05:00–00:00**, Block LAN to WLAN **on**, IGMP Snooping **on** | Peak clients: **27**, Avg RSSI: **-68 dBm**, 95th percentile throughput: **95 Mbps down / 45 Mbps up**, Retry rate: **6%** |
