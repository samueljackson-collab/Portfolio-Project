...
| Detail | Value |
| --- | --- |
| Live URL | `https://24-report-generator.staging.portfolio.example.com` |
| DNS | `24-report-generator.staging.portfolio.example.com` → `CNAME portfolio-gateway.staging.example.net` |
