...
class TestRDSConfiguration:
    ...
    def test_rds_in_private_subnets(self, aws_clients, db_instance_id, stack_outputs):
        ...
        for subnet in response['Subnets']:
            ...
            assert tags.get('Tier') == 'Private', f"RDS subnet {subnet['SubnetId']} should be Private"
    ...
    def test_rds_backup_retention(self, aws_clients, db_instance_id):
        ...
        assert backup_retention >= 7, f"Backup retention should be at least 7 days, got {backup_retention}"
...
class TestRDSSecurityGroup:
    ...
    def test_rds_security_group_exists(self, aws_clients, db_instance_id, stack_outputs):
    ...
    def test_rds_security_group_rules(self, aws_clients, db_instance_id):
        ...
        for sg_id in security_group_ids:
            ...
            assert postgres_rule is not None, "Security group should allow PostgreSQL port 5432"
    ...
    def test_rds_failover_capability(self, aws_clients, db_instance_id):
        ...
        while elapsed_time < max_wait_time:
            ...
            if status == 'available':
                ...
                assert final_az != initial_az, "Failover should change availability zone"
                return
