...
### 3.2 Backend Prompt
Prompt: *Create a backend microservice for Roaming Simulation Platform using a
...
### 3.3 Frontend Prompt
Prompt: *Build a frontend console that visualizes network roaming, mobility
...
Prompt: *Implement observability for Roaming Simulation Platform capturing
...
### 4.2 OKR Template
- Objective: concise, outcome-focused statement linked to Roaming Simulation Platform.
...
Describe a realistic scenario (e.g., high load, partial outage, vendor dependency failure) and explain how the Roaming Simulation Platform architecture responds. Include:
...
Enumerate controls, success measures, tooling decisions, and governance hooks to keep execution disciplined while maximizing learning velocity. Reiterate how the network roaming, mobility policy testing, telecom-grade simulation mission threads through architecture, delivery, operations, and compliance.
