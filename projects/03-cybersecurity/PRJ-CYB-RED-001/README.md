...
Validate detections via safe ATT&CK TTP emulation
...
- [x] Emulation scenario checklist structured with the [Prompt Execution Framework workflow](../../../AI_PROMPT_EXECUTION_FRAMEWORK.md#workflow).
