            ...
            "records": [
                {
                    ...
                    "data": base64.b64encode(
                        json.dumps(guardduty_finding).encode()
                    ).decode(),
                }
            ]
        }
...
class TestCloudTrailTransformation:
    ...
    def test_determine_cloudtrail_severity_root(self):
        ...
        event = {"eventName": "ListBuckets", "userIdentity": {"type": "Root"}}
    ...
    def test_determine_cloudtrail_severity_delete(self):
        ...
        event = {"eventName": "DeleteBucket", "userIdentity": {"type": "IAMUser"}}
            ...
            "records": [
                {
                    "recordId": "gd-1",
                    "data": base64.b64encode(
                        json.dumps(guardduty_log).encode()
                    ).decode(),
                },
                {
                    "recordId": "ct-1",
                    "data": base64.b64encode(
                        json.dumps(cloudtrail_log).encode()
                    ).decode(),
                },
                {
                    "recordId": "vpc-1",
                    "data": base64.b64encode(
                        json.dumps(vpc_flow_log).encode()
                    ).decode(),
                },
            ]
        }
