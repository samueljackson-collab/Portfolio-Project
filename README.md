...
- [Terraform Infrastructure Stack](./terraform/README.md) — Modular VPC/app/monitoring Terraform with CI/CD, security guardrails, and diagrams in [docs/architecture](./docs/architecture/terraform-architecture.md).
